...
import 'package:transformer/Subs.dart';
//import 'package:transformer/menu2.dart';
import 'package:transformer/networkparameter.dart';
import 'package:transformer/productivity.dart';
import 'package:transformer/testdropdown.dart';
//import 'package:transformer/productivity_old.dart';
              ...
              children: <Widget>[
                Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(context,
                          MaterialPageRoute(builder: (context) => DropdownButtonExample())),
                      child: Container(
                        //decoration: BoxDecoration(border: Border.all()),
                        child: Column(
                          children: <Widget>[
